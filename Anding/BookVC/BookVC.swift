...
class BookVC: UIViewController {
    ...
    @IBOutlet weak var blackText: UILabel!
    //    var ids: [Int] = []
    ...
    override func viewDidLoad() {
        ...
        if (bookModel?.bookGetResult?.count) == 0{
            self.blackText.isHidden = false
        }else{
            self.blackText.isHidden = true
        }
    }
            ...
            case .success(_):
                ...
                do {
                    ...
                    DispatchQueue.main.async {
                        ...
                        if (self.bookModel?.bookGetResult?.count) == 0{
                            self.blackText.isHidden = false
                        }else{
                            self.blackText.isHidden = true
                        }
